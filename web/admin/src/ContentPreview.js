    ...
    return (
      <div className="content-preview">
        <div className="phoneBox" style={sectionStyle}>
          <div className="phoneScroll">{this.getComponent(content)}</div>
        </div>
      </div>
    )
  }
  ...
  getComponent = details => {
    switch (details.type) {
      case 'Landing Page Cell':
        return <LandingPage {...details} formBools={this.props.formBools} />
      case 'Details Cell':
        return <SmallView {...details} />
      case 'Dual Details Cell':
        return <DualSmallViews {...details} />
      case 'Squares Cell':
        return <ImageSquares {...details} />
      case 'Squares Row':
        return <SquaresRow {...details} />
      case 'Text Squares Cell':
        return <Squares {...details} />
      case 'Image Carousel':
        return <ImageCarousel {...details} />
      case 'Video Carousel':
        return <VideoCarousel {...details} />
      case 'Speaker Highlight Cell':
        return <SpeakerCarousel {...details} />
      case 'Image Cell':
        return <OneImage {...details} />
      case 'Dual Images Cell':
        return <TwoImage {...details} />
      case 'Text Cell':
        return <TextView {...details} />
      case 'Footer Cell':
        return <ButtonFooter {...details} />
    }
  }
}
